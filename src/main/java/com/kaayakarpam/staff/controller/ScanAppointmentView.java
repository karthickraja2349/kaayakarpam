...
@WebServlet("/scanAppointments")
public class ScanAppointmentView extends HttpServlet{
        ...
        protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException{
                   ...
                   try{
                         ...
                         PreparedStatement scanAppointmentStatement = connection.prepareStatement(SQLQueries.TODAY_SCAN_APPOINTMENTS);
                         scanAppointmentStatement.setInt(1, hospitalId);
                         ResultSet scanAppointmentResultSet = scanAppointmentStatement.executeQuery();
